...
// class definitions
    ...
    private:
         ...
         */
        static DataBuf parsePngChunk(const byte* pData, long size, long& index, int keysize);

        /*!
          @brief Parse PNG chunk contents to extract metadata container. 
                 Supported contents are:
                    Exif, Iptc, and Xmp raw text profile generated by ImageMagick.
                    Xmp packet generated by Adobe.
                    Description string.
         */
        static DataBuf parseChunkContent(const byte* pData, long size, long& index, int keysize);

        /*!
          @brief Decode ImageMagick raw text profile including encoded Exif/Iptc/Xmp metadata byte array.
         */
