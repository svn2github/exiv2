...
// class definitions
    ...
    private:
         ...
         */
        static void parseChunkContent(Image* pImage, const byte *key, const DataBuf arr);

        /*!
          @brief Decode ImageMagick raw text profile which host encoded Exif/Iptc/Xmp metadata byte array.
         */
