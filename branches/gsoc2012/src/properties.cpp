...
namespace Exiv2 {
    ...
    extern const XmpPropertyInfo xmpVideoInfo[] = {
        ...
        { "makerNoteType",      N_("Camera Maker Note Type"),       "Text",                  xmpText, xmpExternal, N_("Contains the information of Maker Note Type of the camera.")   },
        { "makerNoteVersion",   N_("Camera Maker Note Version"),    "Text",                  xmpText, xmpExternal, N_("Contains the information of Maker Note Version of the camera.")   },
        ...
        { "udAlbum",            N_("User Data Album"),              "Text",                  xmpText, xmpExternal, N_("Information about the Album.")   },
        { "udArtist",           N_("User Data Artist"),             "Text",                  xmpText, xmpExternal, N_("Information about the Artist.")   },
        { "udArranger",         N_("User Data Arranger"),           "Text",                  xmpText, xmpExternal, N_("Information about the Arranger.")   },
        { "udArrangerKeywords", N_("User Data Arranger Keywords"),  "Text",                  xmpText, xmpExternal, N_("Information about the Arranger Keywords.")   },
        { "udCameraByteOrder",  N_("User Data Camera Byte Order"),  "Text",                  xmpText, xmpExternal, N_("Information about the Camera Byte Order.")   },
        { "udColorMode",        N_("User Data Color Mode"),         "Text",                  xmpText, xmpExternal, N_("Information about the Color Mode.")   },
        { "udComment",          N_("User Data Comment"),            "Text",                  xmpText, xmpExternal, N_("Information about the Comment.")   },
        { "udComposerKeywords", N_("User Data Composer Keywords"),  "Text",                  xmpText, xmpExternal, N_("Information about the Composer Keywords.")   },
        { "udComposer",         N_("User Data Composer"),           "Text",                  xmpText, xmpExternal, N_("Information about the Composer.")   },
        { "udCompressorVersion",N_("User Data Compressor Version"), "Text",                  xmpText, xmpExternal, N_("Information about the Compressor Version.")   },
        { "udCopyright",        N_("User Data Copyright"),          "Text",                  xmpText, xmpExternal, N_("Information about the Copyright.")   },
        { "udCreateDate",       N_("User Data Create Date"),        "Text",                  xmpText, xmpExternal, N_("Information about the Create Date.")   },
        { "udDirector",         N_("User Data Director"),           "Text",                  xmpText, xmpExternal, N_("Information about the Director.")   },
        { "udEdit1",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit2",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit3",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit4",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit5",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit6",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit7",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit8",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEdit9",            N_("User Data Edit"),               "Text",                  xmpText, xmpExternal, N_("Information about the Edit.")   },
        { "udEncoder",          N_("User Data Encoder"),            "Text",                  xmpText, xmpExternal, N_("Information about the Encoder.")   },
        { "udEquipment",        N_("User Data Equipment"),          "Text",                  xmpText, xmpExternal, N_("Information about the Equipment.")   },
        { "udExposureCompensation",N_("User Data Exposure Compensation"),"Text",             xmpText, xmpExternal, N_("Information about the Exposure Compensation.")   },
        { "udFirmwareVersion",  N_("User Data Firmware Version"),   "Text",                  xmpText, xmpExternal, N_("Information about the Firmware Version.")   },
        { "udFocusMode",        N_("User Data Focus Mode"),         "Text",                  xmpText, xmpExternal, N_("Information of Focus Mode of the Lens.")   },
        { "udFormat",           N_("User Data Format"),             "Text",                  xmpText, xmpExternal, N_("Indication of movie format (computer-generated, digitized, and so on).")   },
        { "udGenre",            N_("User Data Genre"),              "Text",                  xmpText, xmpExternal, N_("Information about the Genre.")   },
        { "udGPSCoordinates",   N_("User Data GPS Coordinates"),    "Text",                  xmpText, xmpExternal, N_("Information about the GPS Coordinates.")   },
        { "udGrouping",         N_("User Data Grouping"),           "Text",                  xmpText, xmpExternal, N_("Information about the Grouping.")   },
        { "udInformation",      N_("User Data Information"),        "Text",                  xmpText, xmpExternal, N_("Information about the movie.")   },
        { "udISRCCode",         N_("User Data ISRCCode"),           "Text",                  xmpText, xmpExternal, N_("Information about the ISRCCode.")   },
        { "udLyrics",           N_("User Data Lyrics"),             "Text",                  xmpText, xmpExternal, N_("Information about the Lyrics.")   },
        { "udMake",             N_("User Data Make"),               "Text",                  xmpText, xmpExternal, N_("Information about the Make.")   },
        { "udMakerURL",         N_("User Data Maker URL"),          "Text",                  xmpText, xmpExternal, N_("Information about the Maker URL.")   },
        { "udModel",            N_("User Data Model"),              "Text",                  xmpText, xmpExternal, N_("Information about the Model.")   },
        { "udName",             N_("User Data Name"),               "Text",                  xmpText, xmpExternal, N_("Information about the Name.")   },
        { "udPerformers",       N_("User Data Performers"),         "Text",                  xmpText, xmpExternal, N_("Information about the Performers.")   },
        { "udPerformerKeywords",N_("User Data Performer Keywords"), "Text",                  xmpText, xmpExternal, N_("Information about the Performer Keywords.")   },
        { "udPerformerURL",     N_("User Data Performer URL"),      "Text",                  xmpText, xmpExternal, N_("Information about the Performer URL.")   },
        { "udPlaySelection",    N_("User Data Play Selection"),     "Text",                  xmpText, xmpExternal, N_("Information about the Play Selection.")   },
        { "udPlayMode",         N_("User Data PlayMode"),           "Text",                  xmpText, xmpExternal, N_("Information about the Play Mode.")   },
        { "udProducer",         N_("User Data Producer"),           "Text",                  xmpText, xmpExternal, N_("Information about the Producer.")   },
        { "udProducerKeywords", N_("User Data Producer Keywords"),  "Text",                  xmpText, xmpExternal, N_("Information about the Producer Keywords.")   },
        { "udRecordLabelName",  N_("User Data Record Label Name"),  "Text",                  xmpText, xmpExternal, N_("Information about the Record Label Name.")   },
        { "udRecordLabelURL",   N_("User Data Record Label URL"),   "Text",                  xmpText, xmpExternal, N_("Information about the Record Label URL.")   },
        { "udRecordingCopyright",N_("User Data Recording Copyright"),"Text",                 xmpText, xmpExternal, N_("Information about the Recording Copyright.")   },
        { "udRequirements",     N_("User Data Requirements"),       "Text",                  xmpText, xmpExternal, N_("Information about the Requirements.")   },
        { "udSourceCredits",    N_("User Data Source Credits"),     "Text",                  xmpText, xmpExternal, N_("Information about the Source Credits.")   },
        { "udSubtitle",         N_("User Data Subtitle"),           "Text",                  xmpText, xmpExternal, N_("Information about the Subtitle.")   },
        { "udSubtitleKeywords", N_("User Data Subtitle Keywords"),  "Text",                  xmpText, xmpExternal, N_("Information about the Subtitle Keywords.")   },
        { "udSongWriter",       N_("User Data Song Writer"),        "Text",                  xmpText, xmpExternal, N_("Information about the Song Writer.")   },
        { "udSongWriterKeywords",N_("User Data Song Writer Keywords"),"Text",                xmpText, xmpExternal, N_("Information about the Song Writer Keywords.")   },
        { "udSoftwareVersion",  N_("User Data Software Version"),   "Text",                  xmpText, xmpExternal, N_("Information about the Software Version.")   },
        { "udTitle",            N_("User Data Title"),              "Text",                  xmpText, xmpExternal, N_("Information about the Title.")   },
        { "udTrack",            N_("User Data Track"),              "Text",                  xmpText, xmpExternal, N_("Information about the Track.")   },
        { "udVendor",           N_("User Data Vendor"),             "Text",                  xmpText, xmpExternal, N_("Information about the Vendor.")   },
        { "udWindowLocation",   N_("User Data Window Location"),    "Text",                  xmpText, xmpExternal, N_("Information about the Window Location.")   },
        ...
        { "XResolution",        N_("Horizontal Resolution"),        "Integer",               xmpText, xmpExternal, N_("A 32-bit fixed-point number containing the horizontal resolution of the image in pixels per inch.")   },
        { "YResolution",        N_("Vertical Resolution"),          "Integer",               xmpText, xmpExternal, N_("A 32-bit fixed-point number containing the vertical resolution of the image in pixels per inch.")   },
        { 0, 0, 0, invalidTypeId, xmpInternal, 0 }
    };
